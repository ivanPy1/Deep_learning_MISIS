...
class SemiSupervisedDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage=None):
        ...
        if self.use_unlabeled and os.path.exists(self.train_unlabeled_csv):
    ...
    def train_dataloader(self):
        ...
        if self.use_unlabeled and self.train_unlabeled_dataset is not None:
            unlabeled_loader = DataLoader(
                self.train_unlabeled_dataset,
                batch_size=self.batch_size - self.labeled_batch_size,
                shuffle=True,
                num_workers=self.num_workers,
                pin_memory=True
            )
